...
const Sensors = () => {
  ...
  const loadSensors = async () => {
    try {
      ...
      const map = roomsResponse.data.reduce(
        (acc, room) => {
  ...
  const sensorsByRoom = filteredSensors.reduce(
    (acc, sensor) => {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Surveillance et contrôle de tous les capteurs
            </p>
          </div>
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent>
                ...
                <DialogFooter>
                  ...
                  <Button onClick={handleAddSensor}>Créer</Button>
                </DialogFooter>
              </DialogContent>
            </Dialog>
          )}
